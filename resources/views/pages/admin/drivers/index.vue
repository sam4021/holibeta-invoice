...
import UpdateDriver from "@/views/components/driver/update.vue";

let props=defineProps({
    drivers: {
        type: Object as PropType<drivers[]>,
        required: true
    },
        ...
        <div>
            <div class="relative">
                <table class="w-full text-sm text-left text-gray-700 font-medium">
                    ...
                    <tr class="border-b" v-for="driver in drivers.data" :key="driver.id" >
                ...
                <!--pagination-->
                <data-pagination :data="drivers"></data-pagination>
            </div>
        </div>
    </div>
</admin>
