...
const submit=()=>{
    ...
    form.post(route('security-check.store'),{
        onSuccess:()=>{
            router.visit(route('security-check.index'))
        }
    })
}
</script>
...
<template>
    <Head title="Add Security Check" />
    <admin>
        <div class="my-3">
            <div>
                <h1 class="text-2xl font-bold">Add a Security Check</h1>
            </div>
            <div class="my-5">
                <form   @submit.prevent="submit">
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        <div>
                            <label for="email" class="text-sm font-medium text-gray-700">front_image</label>
                        ...
                        <div>
                            <label for="email" class="text-sm font-medium text-gray-700">back_image</label>
                        ...
                        <div>
                            <label for="email" class="text-sm font-medium text-gray-700">side_image</label>
