...
<admin>
    ...
    <div class="my-5 grid grid-cols-2 gap-3">
        <div class="flex items-center gap-2">
            ...
            <span class="text-gray-800 font-medium capitalize">{{securityCheck.data.supplier.name}}</span>
        </div>
        <div class="flex items-center gap-2">
            <span class="text-gray-600">Vehicle:</span>
            <span class="text-gray-800 font-medium capitalize">{{securityCheck.data.vehicle.name}}</span>
        </div>
        <div class="flex items-center gap-2">
            <span class="text-gray-600">Created By:</span>
            <span class="text-gray-800 font-medium capitalize">{{securityCheck.data.created_by.name}}</span>
        </div>
        <div class="flex items-center gap-2">
            <span class="text-gray-600">Created at:</span>
            <span class="text-gray-800 font-medium capitalize">{{securityCheck.data.Created_at}}</span>
        </div>
        <div class="flex items-center gap-2">
            <span class="text-gray-600">Vehicle reg no:</span>
            <span class="text-gray-800 font-medium capitalize">{{securityCheck.data.vehicle_reg_no}}</span>
        </div>
    </div>
