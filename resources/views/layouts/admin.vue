...
<template>
    ...
    >
        ...
        >
            <div class="my-3">
                <h1 class="font-bold text-lg">Holibeta</h1>
            </div>
            ...
            >
                ...
                <li v-if="roles.includes('Admin')">
                    <Link
                        ...
                        :class="{
                            'bg-gray-100 text-sky-700':
                                $page.component === 'admin/customer/index',
                        }"
                        data-drawer-hide="default-sidebar"
                    >
                        <svg
                ...
                <li>
                    <Link :href="route('transactions.index')" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-sky-700  hover:bg-gray-100 group"
                          :class="{ 'bg-gray-100 text-sky-700': $page.component === 'admin/transactions/index' }"
                    >
                        <svg class="h-5 fill-gray-900 group-hover:fill-sky-700" :class="{ 'fill-sky-700': $page.component === 'admin/transactions/index' }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <ul class="space-y-2 font-medium pt-3 text-sm">
                    <li v-if="roles.includes('Admin')">
                        ...
                        >
                            ...
                            >
                            <li>
                                    <Link :href="route('vat.index')" class="block px-4 py-3 hover:bg-sumo-500/20">Vat</Link>
                                </li>
                                <!-- <li>
                                    <Link
